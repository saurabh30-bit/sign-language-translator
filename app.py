...
def main():
    ...
    with st.expander("📖 Gesture Lookup Guide (How to Sign)"):
        ...
        | :--- | :--- | :--- | :--- | :--- |
        | 🖐️ **Open Palm** | All 5 fingers extended | `Hello!` | नमस्ते, कैसे हो? | नमस्कार, कसं काय? |
        | ✊ **Closed Fist** | All fingers tucked into palm | `I need help` | मुझे थोड़ी मदद चाहिए | मला थोडी मदत हवी आहे |
        | 🤙 **Shaka Sign** | Thumb & Pinky extended | `Need Water` | मुझे थोड़ा पानी मिलेगा? | थोडं पाणी मिळेल का? |
        | ✌️ **Peace Sign** | Index & Middle fingers extended | `Peace` | सब ठीक है यार | सगळं ठीक आहे भावा |
        | ☝️ **Pointing Up** | Only Index finger extended | `Pay Attention` | ज़रा इधर ध्यान दो | जरा इकडे लक्ष द्या |
        | 👈 **L-Shape** | Thumb & Index extended | `Wait here` | थोड़ी देर यही रुको | थोड्या वेळ इथेच थांबा |
        | 🤏 **Pinky Point**| Only Pinky extended | `Excuse me` | सुनिए मेरी बात | अहो, ऐका कि |
        | 🖖 **Three Fingers**| Index, Middle, Ring extended | `Options` | यहाँ और क्या क्या है? | अजून काय पर्याय आहेत? |
        | 🤘 **Rock On** | Index & Pinky extended | `Awesome!` | एकदम कमाल है यार! | एकदम भारी झक्कास! |
        | 👍 **Thumbs Up** | Only Thumb extended | `Good Job!` | क्या बात है, बहुत बढ़िया! | खूपच छान काम केलंय! |
        | 🤟 **ILY Sign** | Thumb, Index, Pinky extended | `I Love You` | मैं तुमसे प्यार करता हूँ | माझं तुझ्यावर प्रेम आहे |
        | 👌 **OK Sign** | Middle, Ring, Pinky extended | `Perfect` | एकदम सही कहा | एकदम बरोबर |
        | ✋ **Four Fingers** | All but Thumb extended | `Many things` | बहुत सारी बातें हैं | खूप साऱ्या गोष्टी आहेत |
        | 🤌 **Pinched Hand** | All but Index extended | `Almost done` | बस हो ही गया | जवळपास संपलंच आहे |
        | 🛑 **Stop Hand** | All but Pinky extended | `Stop immediately` | अभी के अभी रुक जाओ! | लगेच तिथेच थांबा! |
        | 🤞 **Crossed Fingers**| Ring & Pinky extended | `Together` | हम सब साथ हैं | आपण सगळे एकत्र आहोत |
        | 🤝 **Handshake** | Thumb, Ring, Pinky extended | `Friends` | हम पक्के दोस्त हैं | आपण घट्ट मित्र आहोत |
        | 🤷 **Confused** | Thumb, Index, Middle, Pinky | `What is this?` | भाई ये सब क्या है? | हे सगळं काय चाललंय? |
        | 😵 **Dizzy** | Index & Ring extended | `Confused` | मुझे कुछ समझ नहीं आ रहा | मला काहीच समजत नाहीये |
        | 😔 **Sorry** | Middle & Ring extended | `Sorry` | मुझे माफ़ कर दो | मला माफ करून दे |
