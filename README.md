...
### Features
* **Dual Recognition Modes:** Switch on the fly between "Conversational Phrases" (like 'Hello', 'Peace') and pure **A-Z Alphabet Mapping** if you want to spell things out.
...
### Supported Signs
* **Conversational Mode:** Recognizes 20 distinct conversational combinations (e.g., "Hello", "I Love You", "Peace", "Awesome", "Excuse me"). You can see the full tuple mapping inside `app.py` under the `SIGNS_MAPPING` dictionary.
* **Alphabet Mode:** Uniquely maps the 26 English Alphabets to distinct geometry states listed in `ALPHABET_MAPPING`.
